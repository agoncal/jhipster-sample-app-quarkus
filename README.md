...
## Deployment with NubesGen

```shell
curl "https://nubesgen.com/demo.tgz?region=francecentral&application=APP_SERVICE.free&runtime=SPRING&database=MYSQL.basic&addons=application_insights&gitops=true" | tar -xzvf -
```
